...
#parçalanacak pdf path olarak yazılır
dosyaadi="Kitaplar/2018/5.pdf"
eksi_sayfa=0
ozet_pages = []
abstract_pages = []
keywords_pages = []
...
for startPage in range(len(bildiri_sayfa)):
    ...
    with open("Parcali/deneme/%s.pdf" % startPage, "wb") as outputStream: #parçaların çıkacağı konum path olara yazılır
